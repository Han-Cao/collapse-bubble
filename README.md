...
**TODO**: A new SV merging pipeline that concatenates overlapping variants before SV merging will be developed, which will improve variant merging for tandem repeats.
