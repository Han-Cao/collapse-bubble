...
- [SV merging for PanGenie results (experimental)](#sv-merging-for-pangenie-results-experimental)
- [Todo list](#todo-list)
...
```
git clone https://github.com/Han-Cao/collapse-bubble.git
```

Make sure you have Python>=3.10 installed, and then install the dependencies:
...
## SV merging for PanGenie results (experimental)

[PanGenie](https://github.com/eblerjana/pangenie) is a great tool to genotype SVs in the pangenome graph for WGS data. It is possible to apply `collapse-bubble`'s SV merging results of the graph VCF to `PanGenie` output VCFs. This ensures consistent SV merging between the graph VCF and its genotyping results. The feature is still experimental and can be found in the [pangenie-pipeline](https://github.com/Han-Cao/collapse-bubble/tree/pangenie-pipeline) branch of this repository. Please feel free to [open an issue](https://github.com/Han-Cao/collapse-bubble/issues) if you have any questions.
