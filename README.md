...
SV merging for pangenome VCF generated by `minigraph-cactus` pipeline and decomposed by `vcfwave`. This tool merges similar SVs **within** the same bubble, such as highly polymorphic insertions (INS) at the same position.
